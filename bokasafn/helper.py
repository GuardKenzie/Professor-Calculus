...
def helpCmd(prefix, cmd):
    if cmd == "none":
        ...
        msg.add_field(name="remove [eventId]", value="Removes an event from the schedule", inline=False)
        msg.add_field(name="attend [eventId]", value="Join an event", inline=False)
        msg.add_field(name="leave [eventId]", value="Leave an event", inline=False)
        msg.add_field(name="update [eventId] [update catagory] [new value]", value="Updates a scheduled event", inline=False)
        msg.add_field(name="kick [@member] [eventId]", value="Kicks a user from an event", inline=False)
